# Release Notes
## 2.7.0
- add PageableUtils.toPageable(PagingParam, java.util.function.Supplier<org.springframework.data.domain.Sort>)
...
## 1.0.7 2016-12-28
- add EnumUtils.enumForKey(java.lang.Class<T>, java.lang.Integer)
